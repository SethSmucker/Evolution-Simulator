    ...
    return (function (e) {
                ...
                (i.set = function (e, t, n) {
                    ...
                    (i.setVelocity = function (e, t) {
                        ...
                        (e.positionPrev.x = e.position.x - t.x * n),
                            ...
                            (e.velocity.x =
                                (e.position.x - e.positionPrev.x) / n),
                            (e.velocity.y =
                                (e.position.y - e.positionPrev.y) / n),
                    ...
                    (i.setSpeed = function (e, t) {
                        i.setVelocity(
                            e,
                            r.mult(r.normalise(i.getVelocity(e)), t)
                        );
                    }),
                    ...
                    (i.getAngularVelocity = function (e) {
                        return (
                            ((e.angle - e.anglePrev) * i._baseDelta) /
                            e.deltaTime
                        );
                    }),
                    ...
                    (i.setAngularSpeed = function (e, t) {
                        i.setAngularVelocity(
                            e,
                            s.sign(i.getAngularVelocity(e)) * t
                        );
                    }),
                    (i.translate = function (e, t, n) {
        ...
        function (e, t, n) {
            ...
            (i._motionWakeThreshold = 0.18),
                ...
                (i.update = function (e, t) {
                    for (
                        var n = t / a._baseDelta,
                            r = i._motionSleepThreshold,
                            s = 0;
                        s < e.length;
                        s++
                    ) {
            ...
            (i._warming = 0.4),
                ...
                (i.solveAll = function (e, t) {
                    ...
                    for (o = 0; o < e.length; o += 1)
                        (a =
                            !(r = e[o]).bodyA || (r.bodyA && r.bodyA.isStatic)),
                            (s = !r.bodyB || (r.bodyB && r.bodyB.isStatic)),
                            a || s || i.solve(e[o], n);
                }),
                ...
                "undefined" != typeof window &&
                    ...
                    (i.create = function (e) {
                        ...
                        return (
                            ...
                            (n.canvas =
                                n.canvas ||
                                p(n.options.width, n.options.height)),
                    ...
                    (i.world = function (e, t) {
                        ...
                        if (
                            ...
                            for (n = 0; n < h.length; n++) {
                                ...
                                M && (_ = c.add(M.position, C.pointA)),
                                    ...
                                    _ &&
                                        k &&
                                        (s.contains(e.bounds, _) ||
                                            s.contains(e.bounds, k)) &&
                                        w.push(C);
                            }
                        ...
                        !m.wireframes || (d.enableSleeping && m.showSleeping)
                            ...
                            m.showSeparations &&
                                i.separations(e, d.pairs.list, v),
                            m.showCollisions &&
                                i.collisions(e, d.pairs.list, v),
                            m.showVertexNumbers && i.vertexNumbers(e, S, v),
                            m.showMousePosition &&
                                i.mousePosition(e, e.mouse, v),
                            i.constraints(w, v),
